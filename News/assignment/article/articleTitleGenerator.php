...
class articleTitleGenerator
{
  ...
  public function generateArticleTitle()
  {
    ...
    $articleFormat = $articleFormat . '<div class="title"><a href = "'. $this->articleLink .'">';
    ...
    $articleFormat = $articleFormat . '<p><a id="read" href="'. $this->articleLink .'">Read complete article...</a></p>';
    ...
    $articleFormat = $articleFormat . '<img src = "../public/images/articles/'. $this->articleImage .'" alt = "'. $this->articleImage .'" width = "500px" height = "300px">';
    $articleFormat = $articleFormat . '</div>';
    $articleFormat = $articleFormat . '</div>';
